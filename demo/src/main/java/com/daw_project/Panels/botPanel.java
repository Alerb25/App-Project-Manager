...
public class botPanel extends GridPane {
    ...
    public botPanel() {
        ...
        chatHistory = new Text("Bienvenido al chat de Proyectos, ¿qué te cuentas?");
        ...
        GenerateContentConfig config = GenerateContentConfig.builder()
                .systemInstruction(
                        Content.builder()
                                ...
                                .parts(List.of(
                                        Part.builder()
                                                .text("Eres un programador senior experto en dar ejemplos de proyectos para sumar al portafolio, eres muy bromista")
                                                .build()))
